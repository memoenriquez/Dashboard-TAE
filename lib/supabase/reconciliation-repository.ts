      ...
      .upsert(
        {
          ...
          filename_date_format: input.filenameDateFormat,
          content_date_format: input.contentDateFormat,
...
const mapConfig = (row: JsonRecord): ReconciliationConfig => ({
  ...
  filenameDateFormat: row.filename_date_format === "aaaammdd" ? "aaaammdd" : "ddmmaaaa",
  contentDateFormat: row.content_date_format === "aaaammdd" ? "aaaammdd" : "ddmmaaaa",
  deliveryProtocol: row.delivery_protocol === "ftp" ? "ftp" : "sftp",
